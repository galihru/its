...
BUNDLE_URL="${ITS_CONTROLLER_BUNDLE_URL:-https://itstelkom.web.app/artifacts/its-controller-files.tar.gz?v=20260615-snapshot-widget}"
DOWNLOAD_URL="${ITS_CONTROLLER_JAR_URL:-https://itstelkom.web.app/artifacts/ItsController.jar?v=20260615-snapshot-widget}"
