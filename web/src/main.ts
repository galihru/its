...
`;
  ...
  async function videoYoloSource(overlay: HTMLElement): Promise<{ source: HTMLVideoElement | HTMLImageElement; drawOverlay: boolean } | null> {
    ...
    if (video) return { source: video, drawOverlay: true };
